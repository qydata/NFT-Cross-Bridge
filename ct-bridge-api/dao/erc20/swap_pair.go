...
func (SwapPair) TableName() string {
	return "erc20_swap_pairs"
}

type SwapPairDaoInterface interface {
	GetSwapPairs(params erc_20_swap_pairs.GetErc20SwapPairsParams) (int64, []SwapPair, error)
}
...
func (s *SwapPairDao) GetSwapPairs(params erc_20_swap_pairs.GetErc20SwapPairsParams) (int64, []SwapPair, error) {
