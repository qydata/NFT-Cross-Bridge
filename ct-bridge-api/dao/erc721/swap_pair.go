...
type SwapPairDaoInterface interface {
	GetSwapPairs(params erc_721_swap_pairs.GetErc721SwapPairsParams) (int64, []SwapPair, error)
}
...
func (s *SwapPairDao) GetSwapPairs(params erc_721_swap_pairs.GetErc721SwapPairsParams) (int64, []SwapPair, error) {
