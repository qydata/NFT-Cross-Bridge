...
import (
	...
	"github.com/qydata/ct-evm-compatible-bridge-api/dao"
	"github.com/qydata/ct-evm-compatible-bridge-api/middlewares"
	handler "github.com/qydata/ct-evm-compatible-bridge-api/restapi/handler"
	"github.com/qydata/ct-evm-compatible-bridge-api/restapi/operations"
	"github.com/qydata/ct-evm-compatible-bridge-api/restapi/operations/erc_1155_swap_pairs"
	...
	cfg "github.com/qydata/ct-evm-compatible-bridge-api/config"
	uenv "github.com/qydata/ct-evm-compatible-bridge-api/utils/env"
	"github.com/qydata/ct-evm-compatible-bridge-api/utils/log"
)

//go:generate swagger generate server --target ../../ct-evm-compatible-bridge-api --name BscEvmCompatibleBridgeAPI --spec ../swagger.yml --principal interface{}
